      ...
      <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img
              src={new URL("../assets/whole-eats.jpg", import.meta.url).href}
              class="h-20"
              alt="Whole-Eats Logo"
            />
          </a>
          <div class="flex md:order-2">
            ...
            <button className="cursor-pointer border-2 rounded-lg p-1 ml-4 mr-2">
              Sign In
            </button>
            <button className="cursor-pointer border-2 rounded-lg p-1 mr-2">
              Join
            </button>
          </div>
          <div
